# Generated by Django 3.2.22 on 2023-10-20 22:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='huerto',
            name='usuario',
            field=models.ManyToManyField(to='Huerto.Usuario'),
        ),
        migrations.CreateModel(
            name='Historial',
            fields=[
                ...
                ('descripcion', models.TextField(max_length=2000)),
                ('plaga', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='Huerto.plaga')),
            ],
        ),
        migrations.CreateModel(
            name='Gastos',
            fields=[
                ...
                ('Descripcion', models.TextField(max_length=2000)),
                ('fecha', models.DateTimeField(default=django.utils.timezone.now)),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Huerto.usuario')),
            ],
        ),
        migrations.CreateModel(
            name='Fruto',
