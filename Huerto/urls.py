...
urlpatterns =[
    ...
    path('huerto/lista/',views.huertos_lista,name='huertos_lista'),
    ...
    path('huerto/create/',views.crear_huerto_modelo,name='huerto_create'),
    path('huerto/huertos/',views.huertos_lista,name='huertos_lista'),
    ...
    path('gastos/gastos',views.gasto_lista,name='gasto_lista'),
