...
from Huerto import urls as huerto_urls
...
urlpatterns = [
    ...
    path('Huerto/', include(('Huerto.urls', 'Huerto'), namespace='Huerto')),
    # O, usando la variable importada:
    path('Huerto/', include((huerto_urls, 'Huerto'), namespace='Huerto')),
] 
